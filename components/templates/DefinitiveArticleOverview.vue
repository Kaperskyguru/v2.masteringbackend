...
<template>
  <section>
      ...
      <div class="container">
        ...
        <div class="row justify-content-center text-center">
          ...
          <nuxt-link
            ...
            :key="i"
            :to="`/posts/${post.slug}#${chapter.slug}`"
            class="col-md-3 mb-3 chapter d-flex flex-column align-items-center"
          >
            <div
            ...
            <h6 class="chapter-title mt-2">{{ chapter.description }}</h6>
            <p class="chapter-subtitle lh-md">{{ chapter.title }}</p>
            <!-- </div> -->
          </nuxt-link>
        </div>
      </div>
    ...
    <div id="chapter" class="container mx-auto w-75">
      <div id="chapter" class="py-5 container mx-auto w-md-100 w-75">
