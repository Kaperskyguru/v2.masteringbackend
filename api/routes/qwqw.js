...
*/ var r = Object.getOwnPropertySymbols,
  ...
  function (e, t, n) {
    ...
    var It = zt.extend({
      ...
      jt = Ut.extend({ relatedTarget: null })
    function Dt(e) {
      var t = e.keyCode
      return (
        'charCode' in e
    ...
    function Uo(e, t) {
      return (e = Fo(e)), go(e, t)
    }
    function jo(e, t, n) {
      return (e = Fo(e)), vo(e, t, n)
    }
    function Do(e) {
    ...
    function xi(e) {
      ...
      function d(e, t, n) {
        ...
        if ('object' == typeof t && null !== t) {
          ...
          if (bi(t) || Y(t)) return ((t = wu(t, e.mode, n, null)).return = e), t
          ki(e, t)
        }
        return null
      }
      function p(e, t, n, r) {
        ...
        if ('object' == typeof n && null !== n) {
          ...
          if (bi(n) || Y(n)) return null !== o ? null : f(e, t, n, r, null)
          ki(e, n)
        }
        return null
      }
      function h(e, t, n, r, o) {
        ...
        if ('object' == typeof r && null !== r) {
          ...
          if (bi(r) || Y(r)) return f(t, (e = e.get(n) || null), r, o, null)
          ki(t, r)
        }
        return null
      }
    ...
    function ka(e) {
      ...
      if (
        ...
        for (t = ma; t; ) va(e, t), (t = Gn(t.nextSibling))
      if ((wa(e), 13 === e.tag))
                  ...
                  if (ka(t)) {
                    ...
                    switch (((n[Zn] = i), (n[Jn] = s), c)) {
                      ...
                      case 'select':
                        ...
                        break
                      case 'textarea':
                        Ie(n, s), yn('invalid', n), Fn(r, 'onChange')
                    }
      ...
      (t.unstable_scheduleCallback = function (e, n, a) {
        ...
        return (
          ...
          u > l
            ? ((e.sortIndex = u),
              _(z, e),
              null === C(O) && e === C(z) && (U ? i() : (U = !0), o(D, u - l)))
            : ((e.sortIndex = a), _(O, e), F || I || ((F = !0), r(A))),
          e
        )
      }),
  ...
  function (e, t, n) {
    ...
    function d() {
      var e = s(Object(r.useState)(''), 2),
        t = e[0],
        n = e[1],
        i = s(Object(r.useState)(), 2),
        a = i[0],
        l = i[1],
        f = s(Object(r.useState)(), 2),
        d = f[0],
        p = f[1],
        h = s(Object(r.useState)(), 2),
        m = h[0],
        g = h[1],
        v =
          /^[a-zA-Z0-9.!#$%&'*+\/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$/,
        y = window.CustomSubstackWidget || {},
        b = y.theme,
        w = y.colors,
        k = y.substackUrl,
        x = y.placeholder,
                        ...
                        return (
                          ...
                          fetch(
                            'https://us-central1-substackapi.cloudfunctions.net/subscribe',
                            {
                              ...
                              body: JSON.stringify({
                                email: t,
                                domain: k || 'prostack.substack.com',
                              }),
                            }
                          )
                            .then(function (e) {
                            ...
                            .catch(function (e) {
                              g('Something has gone wrong please try again.')
                            })
                        )
                      case 10:
                        l(!1)
      ...
      return o.a.createElement(
        ...
        o.a.createElement(
          ...
          o.a.createElement('input', {
            placeholder: x || 'example@gmail.com',
            value: t,
            onChange: function (e) {
              n(e.target.value)
            },
        ...
        m && o.a.createElement('p', { className: 'error' }, m),
        !!(d || []).length &&
          o.a.createElement('p', { className: 'success' }, d)
      )
    }
    n(1)
    var p = window.CustomSubstackWidget.element || '#custom-substack-embed'
    document.querySelectorAll(p).forEach(function (e) {
      return a.a.render(o.a.createElement(d, null), e)
    })
  },
])
